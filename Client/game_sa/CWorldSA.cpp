...
#include <detours/4.0.1/src/detours.h>
...
RwStream* pluginExtraVertColourStreamWriteCB(RwStream* stream, int binaryLength, RpGeometry* geo)
{
    VertexColorPlugin* self = geo->GetVertexColorPlugin();
